# -*- coding: utf-8 -*-
"""
Created on Wed Apr 26 20:28:05 2023
...
from scipy.interpolate import interp1de
...
ip_address = 0; sig1 = 0; sig1_rms = 0; sig2=0; sig2_rms=0;audio = 0; frames = 0
...
while __name__ == '__main__':
    ...
    if state == 0: #Read theta values until they =2pi, meaning we having finished 360 degrees 
        ...
        #UDP Packets
            ...
            theta_list[0].extend([t]) #extend with new time  #difference between extend and append
    ...
    elif state == 1:# Referencing Cross Correlation Example
        ...
        sig1_inp = interp1de(theta_list[0],sig1_rms, kind = 'nearest') #theta_list[0]=thetalist time, sig1=mic signal Try other kinds to see accuracy
        state = 2
