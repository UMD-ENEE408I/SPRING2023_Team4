# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 12:43:53 2023
...
# =============================================================================
    ...
    if state == 0: #find indeces of microphones #find device id for microphone
        ...
        for i in range(0, numdevices):
            ...
            if (audio.get_device_info_by_host_api_device_index(0, i).get('maxInputChannels')) <= 1:
                ...
                #print("Input Device id ", i, " - ", dev_info['name'])
                name=dev_info['name']
                new_string=name.split(" ")
                #print(new_string)
                if new_string[0]=='Microphone':
                    print("USB Found") 
                #print(dev_info)
    ...
    # =============================================================================
        ...
        #rms3 = np.sqrt(np.mean(sig3**2)) COMmented signal 3
